...
KeepAliveBroker = 60
TopicoSubscribe = 'GIOT-GW/UL/#' #Topico que ira se inscrever
...
def on_message(client, userdata, msg):
    ...
    data_length = len(dict_payload['data'])
    if data_length > 2:
    #print(dict_payload)
        ...
        lista_de_campos = [
            ...
            {'key':'fator_potencia_linha','type':'str','fields':('1d','1e','1d')},
            ...
            {'key':'ct_pulso','type':'pulso','fields':('24','25','26')},
        ...
        dict_save = {}
        dict_save['id_dispositivo'] = dict_payload['macAddr']
